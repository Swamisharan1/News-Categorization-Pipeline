...
try:
    app = Celery('myapp', broker='amqp://pzfuaogi:6gS39PKAPp1iZ8jkGrGpETcyy2-n7Ji9@hawk.rmq.cloudamqp.com/pzfuaogi')
except Exception as e:
    logging.error(f"Error setting up Celery app: {e}")

# Set up the database
try:
    engine = create_engine('postgresql://hlebjvxl:rpgycGgIO6xLDHOn7Puyx3S3QE3lxwv-@kashin.db.elephantsql.com/hlebjvxl',
        poolclass=QueuePool,
        pool_size=5,
        max_overflow=5)
